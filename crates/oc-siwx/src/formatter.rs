...
use crate::{
    message::SiwxMessage,
    parser::{
        CHAIN_TAG, EXP_TAG, IAT_TAG, NBF_TAG, NONCE_TAG, PREAMBLE_MID, PREAMBLE_TAIL, RES_TAG,
...
impl SiwxMessage {
    ...
    /// `"Ethereum"`, `"Solana"`). Prefer [`crate::SyncVerifier::format_message`]
    /// so the chain label cannot drift from verification.
    #[must_use]
