...
mod tests {
    ...
    use super::*;
    use crate::{curve::Curve, hd::HdDeriver, mnemonic::Mnemonic};
    ...
    fn test_derive_address_24word_index_0() {
        ...
        assert_eq!(address, "nano_1pu7p5n3ghq1i1p4rhmek41f5add1uh34xpb94nkbxe8g4a6x1p69emk8y1d");
    }
    ...
    fn test_pubkey_hex_24word_index_0() {
        ...
        assert_eq!(pubkey_hex, "5b65b0e8173ee0802c2c3e6c9080d1a16b06de1176c938a924f58670904e82c4");
    }
    ...
    fn test_derive_address_12word_index_0() {
        ...
        let signer = NanoSigner;
        let address = signer.derive_address(&key).unwrap();
        assert_eq!(address, "nano_16tfkg33dxndscjt3sdnzqjkdz4d5cxfmhbxf87zxycp8gtnzytqmcosi3zr");
    }
    ...
    fn test_encode_signed_transaction_wrong_block_len() {
        ...
        let sig = SignOutput { signature: vec![0u8; 64], recovery_id: None, public_key: None };
