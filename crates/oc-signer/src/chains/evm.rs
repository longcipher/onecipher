...
impl ChainSigner for EvmSigner {
    ...
    fn derive_address(&self, private_key: &[u8]) -> Result<String, SignerError> {
        ...
        let pubkey_bytes = verifying_key.to_sec1_point(false);
...
mod tests {
    ...
    fn test_sign_and_recover_roundtrip() {
        ...
        verifying_key.verify_prehash(&message_hash, &sig).expect("signature should verify");
    }
    ...
    fn test_authorization_payload_uses_magic_byte_and_rlp_tuple() {
        ...
        assert_eq!(hex::encode(payload), "05d78094111111111111111111111111111111111111111180");
    }
    ...
    fn test_sign_message_v_byte_27_or_28() {
        ...
        assert!(v == 27 || v == 28, "EIP-191 personal_sign v byte should be 27 or 28, got {v}");
    }
    ...
    fn test_sign_message_recovery_id_matches_v() {
        ...
        assert_eq!(v, recovery_id, "v byte in signature should match recovery_id field");
        assert!(
    ...
    fn test_sign_message_verifiable_with_v_27_28() {
        ...
        verifying_key.verify_prehash(&hash, &sig).expect("signature should verify");
